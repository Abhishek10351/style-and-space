...
const Header = () => {
    ...
    return (
        <header className="fixed top-0 left-0 right-0 z-50 bg-background/40 backdrop-blur-lg border-b border-border w-screen">
            <div className="container mx-auto md:w-screen px-4 md:px-0 py-4">
